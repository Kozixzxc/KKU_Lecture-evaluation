...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
 ...
 <%
 	...
 	if(request.getParameter("pageNumber") != null){
  	...
  	if(emailChecked == false) { //이메일 인증이 안 된 경우
  		PrintWriter script = response.getWriter();
  		script.println("<script>");
 ...
 %>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-success">
      ...
      <a class="navbar-brand" href="index.jsp" style="font-size:30px">KKU_LE</a>
      ...
      <div class="collapse navbar-collapse" id="navbar">
        ...
        <form action="./index.jsp" method="get" class="form-inline my-2 my-lg-0">
          ...
          <input type="text" name="search" class="form-control mr-sm-2"  placeholder="통합검색" aria-label="Search">

          <button class="btn btn-success btn-md my-2 my-sm-0" type="submit">검색</button>
